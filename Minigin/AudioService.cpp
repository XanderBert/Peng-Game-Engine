...
AudioService::AudioService() : m_StopRequested(false)
{
	...
	m_AudioThread = std::jthread(&AudioService::PlayAudioAsync, this);
}
...
Mix_Chunk* AudioService::AddSound(const int id, const std::string& file)
{
...
void AudioService::PlayAudioAsync()
{
