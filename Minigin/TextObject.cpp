...
void TextObject::Update([[maybe_unused]] float deltaT)
{
	if (m_needsUpdate)
	{
...
void TextObject::FixedUpdate([[maybe_unused]] float fixedTimeStep)
{
}

void TextObject::LateUpdate([[maybe_unused]] float deltaT)
{
}
